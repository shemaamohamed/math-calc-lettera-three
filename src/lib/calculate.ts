/**
 * Arabic Arbitrary-Precision Math Calculation Library (5-Step Paper Version)
 */
...
export function calculateArabicPower(
  ...
  const section1: Section1Item[] = normalizedChars.map((c, idx) => {
    ...
    return {
      ...
      percentageFraction: ratioFraction,
      percentageDisplay: ratioFraction.toString(),
      termFraction: resultFraction,
      resultFraction,
